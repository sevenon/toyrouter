...
copy_file lan-ip-config.sh      $stage      $inst/etc   u=rwx,g=rx,o=rx
...
cp $stage/ubuntu-grub-menu /etc/grub.d/15_toyrouter
cat /etc/grub.d/10_linux >>/etc/grub.d/15_toyrouter
chmod u=rwx,g=rx,o=rx /etc/grub.d/15_toyrouter

cp $stage/ubuntu-grub.cfg /etc/default/grub.d/toyrouter-grub.cfg
chmod u=rw,g=r,o=r /etc/default/grub.d/toyrouter-grub.cfg
